//
//  niweishenmezhemediaoAppController.mm
...
- (void)setupAdView:(id)sender
{
    ...
    [controller setAdRootController:viewController];
    controller.bSuperOrientFix = YES;
    
    [controller loadView];
    [viewController.view addSubview:controller.adView];
    [controller setAdPosition:CGPointMake([viewController.view frame].size.width, [viewController.view frame].size.height) ];
...
//        [Flurry startSession: @"5523Y5FQM8WV8Q4QRCD6"];
   ...
   [viewController.view addSubview: simple.bannerView];
}

- (void)releaseAdView:(id)sender
{
